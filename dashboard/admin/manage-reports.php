...
// Process actions (mark as spam or restore)
if (isset($_GET['action']) && isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    try {
        if ($action == 'mark_spam') {
            ...
            $stmt = $conn->prepare("DELETE FROM matches WHERE lost_item_id = ? OR found_item_id = ?");
...
<!-- Admin Reports Management Content -->
<h1 class="text-2xl font-bold">Manage Reports</h1>
<p class="text-gray-600 mb-6">View, filter, and manage lost and found reports.</p>
...
<div class="bg-white rounded-lg shadow-md p-4 mb-6">
    <form method="GET" class="space-y-4">
        ...
        <div class="flex justify-end">
            <a href="manage-reports.php" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 mr-2">
                Reset
            </a>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <?php elseif ($item['status'] == 'spam'): ?>
                                        <a href="?action=restore&id=<?php echo $item['id']; ?>&page=<?php echo $page; ?>&search=<?php echo urlencode($search); ?>&type=<?php echo urlencode($type); ?>&status=<?php echo urlencode($status); ?>&category=<?php echo urlencode($category); ?>" 
